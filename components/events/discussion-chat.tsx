    ...
    return (
        <div className="border-b border-black/5 dark:border-white/5 py-4">
            <div className="flex gap-3">
                {/* Avatar */}
                <div className="flex size-[36px] min-w-[36px] items-center justify-center rounded-full bg-black/10 dark:bg-white/10 overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <span className="text-[13px] font-semibold dark:text-white">{comment.user.firstName}</span>
